...
public class IMGuiLayer
{
    ...
    public void initImGui()
    {
        ...
        fontAtlas.addFontFromFileTTF("assets/fonts/cambriai.ttf", 32, fontConfig);

        // After all fonts were added we don't need this config more
        fontConfig.destroy();

        // Use freetype instead of stb_truetype to build a fonts texture
        //TODO: Figure out where this dependency comes from, not in ft native dependency where docs says it is.
